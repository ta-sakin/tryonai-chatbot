// TryOn AI Widget for Express Server
(function () {
  "use strict";

  // Configuration
  const API_BASE_URL =
    window.TRYON_AI_CONFIG?.apiUrl || "http://localhost:5000/api";
  ...
  class TryOnWidget {
    ...
    async init(publicKey) {
      try {
        ...
        this.createWidget();
        this.trackEvent("widget_init");

        return data;
      } catch (error) {
        console.error("TryOn AI Widget initialization failed:", error);
        throw error;
      }
    }

    async tryOn(userImage, clothingImage, clothingImageUrl) {
      if (!this.isInitialized) {
        throw new Error("Widget not initialized. Call init() first.");
      }

      try {
        const response = await fetch(`${NHOST_FUNCTIONS_URL}/try-on`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        this.trackEvent("try_on_completed", { sessionId: result.sessionId });
        return result;
      } catch (error) {
        this.trackEvent("try_on_failed", { error: error.message });
        throw error;
      }
    }
    ...
    async trackEvent(eventType, metadata = {}) {
      ...
      try {
        await fetch(`${NHOST_FUNCTIONS_URL}/analytics`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
    ...
    createWidget() {
      ...
      widget.className = "tryon-widget";
      widget.innerHTML = `
        <button class="tryon-widget-button" onclick="window.tryOnWidget.openModal()">
          Try On AI
        </button>
      `;
    ...
    openModal() {
      ...
      modal.className = "tryon-widget-modal";
      modal.innerHTML = `
        <div class="tryon-widget-content">
          <h3>Virtual Try-On</h3>
          <p>Upload your photo and a clothing item to see how it looks on you!</p>
          <div style="margin: 16px 0;">
            <label>Your Photo:</label>
            <input type="file" id="user-image" accept="image/*" style="display: block; margin: 8px 0;">
          </div>
          <div style="margin: 16px 0;">
            <label>Clothing Item:</label>
            <input type="file" id="clothing-image" accept="image/*" style="display: block; margin: 8px 0;">
            <p style="margin: 8px 0; font-size: 12px; color: #666;">Or paste image URL:</p>
            <input type="url" id="clothing-url" placeholder="https://example.com/image.jpg" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
          </div>
          <div style="margin: 16px 0;">
            <button onclick="window.tryOnWidget.processTryOn()" style="background: #007bff; color: white; border: none; padding: 12px 24px; border-radius: 6px; cursor: pointer; margin-right: 8px;">
              Try On
            </button>
            <button onclick="window.tryOnWidget.closeModal()" style="background: #6c757d; color: white; border: none; padding: 12px 24px; border-radius: 6px; cursor: pointer;">
              Cancel
            </button>
          </div>
          <div id="tryon-result" style="margin-top: 16px;"></div>
        </div>
      `;
    ...
    async processTryOn() {
      ...
      const clothingImageFile =
        document.getElementById("clothing-image").files[0];
      const clothingUrl = document.getElementById("clothing-url").value;
      const resultDiv = document.getElementById("tryon-result");

      if (!userImageFile) {
        resultDiv.innerHTML =
          '<p style="color: red;">Please upload your photo.</p>';
        return;
      }

      if (!clothingImageFile && !clothingUrl) {
        resultDiv.innerHTML =
          '<p style="color: red;">Please upload a clothing item or provide an image URL.</p>';
        return;
      }

      resultDiv.innerHTML = "<p>Processing... This may take a few moments.</p>";

      try {
        const userImage = await this.fileToBase64(userImageFile);
        let clothingImage = null;

        if (clothingImageFile) {
          clothingImage = await this.fileToBase64(clothingImageFile);
        }

        const result = await this.tryOn(userImage, clothingImage, clothingUrl);

        resultDiv.innerHTML = `
          <h4>Try-On Result:</h4>
          <img src="${result.resultImage}" style="max-width: 100%; border-radius: 8px;" alt="Try-on result">
          <p style="margin-top: 8px; font-size: 12px; color: #666;">Session ID: ${result.sessionId}</p>
        `;
      } catch (error) {
  ...
  function initWidget() {
    const script =
      ...
      document.querySelector("script[data-tryon-key]");
    const publicKey = script?.getAttribute("data-tryon-key");

    if (!publicKey) {
      console.error("TryOn AI: Missing data-tryon-key attribute");
      return;
    }

    window.tryOnWidget = new TryOnWidget();
    window.tryOnWidget.init(publicKey).catch((error) => {
      console.error("TryOn AI Widget failed to initialize:", error);
    });
  }
...
(function () {
  ...
  var gl = (vl.prototype = new Vi());
  (gl.constructor = vl), Fi(gl, It.prototype), (gl.isPureReactComponent = !0);
  var $i = Array.isArray,
    Hi = Object.prototype.hasOwnProperty,
    yl = { current: null },
    Ai = { key: !0, ref: !0, __self: !0, __source: !0 };
  function Bi(e, t, n) {
    var r,
      l = {},
      o = null,
    ...
    if (t != null)
      ...
      t))
        Hi.call(t, r) && !Ai.hasOwnProperty(r) && (l[r] = t[r]);
  ...
  (T.Children = {
    ...
    (T.cloneElement = function (e, t, n) {
      ...
      if (t != null) {
        if (
          (t.ref !== void 0 && ((o = t.ref), (i = yl.current)),
  ...
  (bn.Fragment = kc), (bn.jsx = Ki), (bn.jsxs = Ki), (Ri.exports = bn);
  var y = Ri.exports,
    Yi = { exports: {} },
    me = {},
    Xi = { exports: {} },
   ...
   */ (function (e) {
    ...
    function r(C) {
      ...
      if (j !== z) {
        C[0] = j;
        e: for (var Q = 0, J = C.length, ml = J >>> 1; Q < ml; ) {
          var jt = 2 * (Q + 1) - 1,
            Ii = C[jt],
            Tt = jt + 1,
            hl = C[Tt];
          if (0 > l(Ii, j))
            Tt < J && 0 > l(hl, Ii)
              ? ((C[Q] = hl), (C[Tt] = j), (Q = Tt))
              : ((C[Q] = Ii), (C[jt] = j), (Q = jt));
          else if (Tt < J && 0 > l(hl, j)) (C[Q] = hl), (C[Tt] = j), (Q = Tt);
          else break e;
        }
      }
      return z;
    ...
    function v(C) {
      if (((S = !1), f(C), !k))
        if (n(s) !== null) (k = !0), ji(x);
        else {
          var z = n(c);
          z !== null && Ti(v, z.startTime - C);
        }
    }
    function x(C, z) {
      (k = !1), S && ((S = !1), d(P), (P = -1)), (w = !0);
      var j = p;
      try {
        for (
          f(z), m = n(s);
          m !== null && (!(m.expirationTime > z) || (C && !Re()));
        ...
        if (m !== null) var ml = !0;
          ...
          var jt = n(c);
          jt !== null && Ti(v, jt.startTime - z), (ml = !1);
        }
        return ml;
      } finally {
        (m = null), (p = j), (w = !1);
        ...
        return (
          ...
          j > Q
            ? ((C.sortIndex = j),
              ...
              n(s) === null &&
                C === n(c) &&
                (S ? (d(P), (P = -1)) : (S = !0), Ti(v, j - Q)))
            : ((C.sortIndex = J), t(s, C), k || w || ((k = !0), ji(x))),
          C
        );
      }),
  ...
  function Rt(e, t) {
    for (an[e] = t, e = 0; e < t.length; e++) Gi.add(t[e]);
  }
  var Ve = !(
      typeof window > "u" ||
...
` + l[i].replace(" at new ", " at ");
  ...
  function Dl(e, t) {
    ...
    t.hasOwnProperty("value")
      ? Fl(e, t.type, n)
      : t.hasOwnProperty("defaultValue") && Fl(e, t.type, Je(t.defaultValue)),
      t.checked == null &&
  ...
  function hu(e) {
    if ((e = Dn(e))) {
      if (typeof Wl != "function") throw Error(g(280));
      var t = e.stateNode;
      t && ((t = Lr(t)), Wl(e.stateNode, e.type, t));
    }
  }
  function vu(e) {
    Ft ? (Ut ? Ut.push(e) : (Ut = [e])) : (Ft = e);
  }
  function gu() {
    if (Ft) {
      var e = Ft,
        t = Ut;
      if (((Ut = Ft = null), hu(e), t)) for (e = 0; e < t.length; e++) hu(t[e]);
    }
  }
  function yu(e, t) {
    return e(t);
  ...
  function Fc(e, t, n, r, l, o, i, u, s) {
    (gn = !1), (ur = null), Oc.apply(Dc, arguments);
  }
  function Uc(e, t, n, r, l, o, i, u, s) {
    if ((Fc.apply(this, arguments), gn)) {
      if (gn) {
        var c = ur;
        (gn = !1), (ur = null);
  ...
  function xu(e) {
    if (gt(e) !== e) throw Error(g(188));
  }
  function Vc(e) {
    var t = e.alternate;
    if (!t) {
      if (((t = gt(e)), t === null)) throw Error(g(188));
      return t !== e ? null : e;
    }
    for (var n = e, r = t; ; ) {
      var l = n.return;
  ...
  var _u = he.unstable_scheduleCallback,
    Nu = he.unstable_cancelCallback,
    $c = he.unstable_shouldYield,
    Hc = he.unstable_requestPaint,
    W = he.unstable_now,
    Ac = he.unstable_getCurrentPriorityLevel,
    Xl = he.unstable_ImmediatePriority,
    Pu = he.unstable_UserBlockingPriority,
    ar = he.unstable_NormalPriority,
    Bc = he.unstable_LowPriority,
    zu = he.unstable_IdlePriority,
    cr = null,
    Me = null;
  function Wc(e) {
    if (Me && typeof Me.onCommitFiberRoot == "function")
      try {
        Me.onCommitFiberRoot(cr, e, void 0, (e.current.flags & 128) === 128);
      } catch {}
  }
  var Ne = Math.clz32 ? Math.clz32 : Yc,
    Qc = Math.log,
    Kc = Math.LN2;
  function Yc(e) {
  ...
  function qc(e, t, n, r, l) {
    switch (t) {
      case "focusin":
        return (qe = xn(qe, e, t, n, r, l)), !0;
      case "dragenter":
        return (be = xn(be, e, t, n, r, l)), !0;
      case "mouseover":
      ...
      case "gotpointercapture":
        return (
          (o = l.pointerId), Sn.set(o, xn(Sn.get(o) || null, e, t, n, r, l)), !0
        );
    }
    return !1;
  }
  ...
  function hr(e) {
    ...
    for (var t = e.targetContainers; 0 < t.length; ) {
      ...
      } else return (t = Dn(n)), t !== null && ql(t), (e.blockedOn = n), !1;
      t.shift();
    }
    return !0;
  }
  ...
  function Cn(e) {
    ...
    for (; 0 < tt.length && ((n = tt[0]), n.blockedOn === null); )
      Du(n), n.blockedOn === null && tt.shift();
  }
  ...
  function eo(e, t, n, r) {
    if (vr) {
      var l = to(e, t, n, r);
      if (l === null) wo(e, t, r, gr, n), Ou(e, r);
      else if (qc(l, e, t, n, r)) r.stopPropagation();
      else if ((Ou(e, r), t & 4 && -1 < Jc.indexOf(e))) {
        for (; l !== null; ) {
          var o = Dn(l);
          if (
            (o !== null && Tu(o),
            (o = to(e, t, n, r)),
            o === null && wo(e, t, r, gr, n),
            o === l)
          )
            break;
          l = o;
  ...
  var gr = null;
  function to(e, t, n, r) {
    if (((gr = null), (e = Bl(r)), (e = yt(e)), e !== null))
  ...
  var $t = {
    ...
    Sr = $({}, _n, {
      ...
      movementX: function (e) {
        return "movementX" in e
          ...
          : (e !== Nn &&
              (Nn && e.type === "mousemove"
                ? ((lo = e.screenX - Nn.screenX), (oo = e.screenY - Nn.screenY))
                : (oo = lo = 0),
              (Nn = e)),
            lo);
      },
    ...
    Hu = ve(Sr),
    rf = $({}, Sr, { dataTransfer: 0 }),
    lf = ve(rf),
    of = $({}, _n, { relatedTarget: 0 }),
    io = ve(of),
    uf = $({}, $t, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    sf = ve(uf),
    af = $({}, $t, {
  ...
  var vf = $({}, _n, {
    ...
    kf = ve(wf),
    Sf = $({}, $t, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    xf = ve(Sf),
    Ef = $({}, Sr, {
      deltaX: function (e) {
        return "deltaX" in e
    ...
    Cf = ve(Ef),
    _f = [9, 13, 27, 32],
    so = Ve && "CompositionEvent" in window,
    Pn = null;
  Ve && "documentMode" in document && (Pn = document.documentMode);
  var Nf = Ve && "TextEvent" in window && !Pn,
    Wu = Ve && (!so || (Pn && 8 < Pn && 11 >= Pn)),
    Qu = " ",
    Ku = !1;
  function Yu(e, t) {
    switch (e) {
  ...
  function zf(e, t) {
    if (Ht)
      return e === "compositionend" || (!so && Yu(e, t))
        ? ((e = Vu()), (yr = no = nt = null), (Ht = !1), e)
        : null;
    switch (e) {
      case "paste":
        return null;
    ...
    if (Ve) {
      ...
      if (!co) {
        ...
        qu.setAttribute("oninput", "return;"),
          (co = typeof qu.oninput == "function");
      }
      ao = co;
    } else ao = !1;
    Ju = ao && (!document.documentMode || 9 < document.documentMode);
  }
  function bu() {
    zn && (zn.detachEvent("onpropertychange", es), (Ln = zn = null));
  }
  function es(e) {
    if (e.propertyName === "value" && xr(Ln)) {
      var t = [];
      Gu(t, Ln, e, Bl(e)), ku(jf, t);
    }
  }
  function If(e, t, n) {
    e === "focusin"
      ? (bu(), (zn = t), (Ln = n), zn.attachEvent("onpropertychange", es))
      : e === "focusout" && bu();
  }
  function Rf(e) {
  ...
  function jn(e, t) {
    ...
    for (r = 0; r < n.length; r++) {
      var l = n[r];
      if (!Sl.call(t, l) || !Pe(e[l], t[l])) return !1;
    }
    return !0;
  }
  function ts(e) {
  ...
  var Uf = Ve && "documentMode" in document && 11 >= document.documentMode,
    At = null,
    po = null,
    Tn = null,
    mo = !1;
  ...
  function Cr(e) {
    ...
    var t = Bt[e],
      n;
    for (n in t) if (t.hasOwnProperty(n) && n in is) return (ho[e] = t[n]);
    return e;
  }
  var us = Cr("animationend"),
    ss = Cr("animationiteration"),
    as = Cr("animationstart"),
    cs = Cr("transitionend"),
    fs = new Map(),
    ds =
  ...
  for (var vo = 0; vo < ds.length; vo++) {
    var go = ds[vo],
      Vf = go.toLowerCase(),
      $f = go[0].toUpperCase() + go.slice(1);
    rt(Vf, "on" + $f);
  }
  rt(us, "onAnimationEnd"),
    rt(ss, "onAnimationIteration"),
    rt(as, "onAnimationStart"),
    rt("dblclick", "onDoubleClick"),
    rt("focusin", "onFocus"),
    rt("focusout", "onBlur"),
    rt(cs, "onTransitionEnd"),
  ...
  function ms(e, t) {
    ...
    if (sr) throw ((e = Yl), (sr = !1), (Yl = null), e);
  }
  function D(e, t) {
    var n = t[_o];
    ...
    if (!e[_r]) {
      (e[_r] = !0),
        Gi.forEach(function (n) {
          n !== "selectionchange" && (Hf.has(n) || yo(n, !1, e), yo(n, !0, e));
        });
      var t = e.nodeType === 9 ? e : e.ownerDocument;
      t === null || t[_r] || ((t[_r] = !0), yo("selectionchange", !1, t));
    }
  }
  function hs(e, t, n, r) {
    switch (Uu(t)) {
          ...
          for (var a = c, f; a !== null; ) {
            ...
            if (
              (f.tag === 5 &&
                ...
                ((f = v),
                d !== null &&
                  ((v = hn(a, d)), v != null && S.push(Mn(a, v, f)))),
              O)
            )
              break;
            a = a.return;
        ...
        e: {
          ...
          if (
            ...
            if (
              ...
              t: {
                for (S = w, d = k, a = 0, f = S; f; f = Wt(f)) a++;
        ...
        P &&
          (Wu &&
            ...
            (Ht || P !== "onCompositionStart"
              ? P === "onCompositionEnd" && Ht && (N = Vu())
              : ((nt = h),
                (no = "value" in nt ? nt.value : nt.textContent),
                (Ht = !0))),
          (_ = Nr(c, P)),
          0 < _.length &&
            ((P = new Au(P, e, null, n, h)),
            m.push({ event: P, listeners: _ }),
            N ? (P.data = N) : ((N = Xu(n)), N !== null && (P.data = N)))),
          (N = Nf ? Pf(e, n) : zf(e, n)) &&
  ...
  function vs(e, t, n, r, l) {
    for (var o = t._reactName, i = []; n !== null && n !== r; ) {
      ...
      u.tag === 5 &&
        ...
        ((u = c),
        l
          ? ((s = hn(n, o)), s != null && i.unshift(Mn(n, s, u)))
          : l || ((s = hn(n, o)), s != null && i.push(Mn(n, s, u)))),
        (n = n.return);
    }
...
`
  ...
  function Pr(e, t, n) {
    if (((t = gs(t)), gs(e) !== t && n)) throw Error(g(425));
  }
  function zr() {}
  var ko = null,
    So = null;
  ...
  var Eo = typeof setTimeout == "function" ? setTimeout : void 0,
    ...
    Qf =
      typeof queueMicrotask == "function"
        ...
        : typeof ys < "u"
        ? function (e) {
            return ys.resolve(null).then(e).catch(Kf);
          }
        : Eo;
  function Kf(e) {
    setTimeout(function () {
  ...
  var Qt = Math.random().toString(36).slice(2),
    Oe = "__reactFiber$" + Qt,
    On = "__reactProps$" + Qt,
    He = "__reactContainer$" + Qt,
    _o = "__reactEvents$" + Qt,
    Yf = "__reactListeners$" + Qt,
    Xf = "__reactHandles$" + Qt;
  function yt(e) {
    var t = e[Oe];
    if (t) return t;
  ...
  function ks(e, t, n) {
    if (te.current !== it) throw Error(g(168));
    M(te, t), M(ae, n);
  }
  function Ss(e, t, n) {
    var r = e.stateNode;
  ...
  function ut() {
    if (!Po && Ae !== null) {
      ...
      try {
        ...
        throw (Ae !== null && (Ae = Ae.slice(e + 1)), _u(Xl, ut), l);
      } finally {
        (R = t), (Po = !1);
      }
    }
  ...
  var Zt = [],
    ...
    We = "";
  function St(e, t) {
    (Zt[Gt++] = Mr), (Zt[Gt++] = Rr), (Rr = e), (Mr = t);
  }
  function Cs(e, t, n) {
    (ke[Se++] = Be), (ke[Se++] = We), (ke[Se++] = kt), (kt = e);
    var r = Be;
    e = We;
    var l = 32 - Ne(r) - 1;
    (r &= ~(1 << l)), (n += 1);
    ...
    if (30 < o) {
      ...
      (o = (r & ((1 << i) - 1)).toString(32)),
        (r >>= i),
        (l -= i),
        (Be = (1 << (32 - Ne(t) + l)) | (n << l) | r),
        (We = o + e);
    } else (Be = (1 << o) | (n << l) | r), (We = e);
  }
  function zo(e) {
    e.return !== null && (St(e, 1), Cs(e, 1, 0));
  }
  function Lo(e) {
    for (; e === Rr; )
      (Rr = Zt[--Gt]), (Zt[Gt] = null), (Mr = Zt[--Gt]), (Zt[Gt] = null);
    for (; e === kt; )
      (kt = ke[--Se]),
        (ke[Se] = null),
        (We = ke[--Se]),
    ...
    switch (e.tag) {
        ...
        return (
          (t =
            t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
              ...
              : t),
          t !== null
            ? ((e.stateNode = t), (ge = e), (ye = lt(t.firstChild)), !0)
            : !1
        );
      case 6:
        return (
      ...
      case 13:
        return (
          ...
          t !== null
            ? ((n = kt !== null ? { id: Be, overflow: We } : null),
              (e.memoizedState = {
                dehydrated: t,
                treeContext: n,
  ...
  function Or(e) {
    ...
    if (
      ...
      if (jo(e)) throw (zs(), Error(g(418)));
      for (; t; ) _s(e, t), (t = lt(t.nextSibling));
    }
    if ((Ps(e), e.tag === 13)) {
  ...
  function js(e) {
        ...
        : a !== null &&
          (a.elementType === x ||
            (typeof x == "object" &&
              ...
              x.$$typeof === Ge &&
              Ls(x) === a.type))
        ? ((v = l(a, f.props)), (v.ref = Fn(d, a, f)), (v.return = d), v)
        : ((v = il(f.type, f.key, f.props, null, d.mode, v)),
          (v.ref = Fn(d, a, f)),
          (v.return = d),
          v);
    }
    function c(d, a, f, v) {
      return a === null ||
        ...
        ? ((a = Ci(f, d.mode, v)), (a.return = d), a)
        : ((a = l(a, f.children || [])), (a.return = d), a);
    }
    function h(d, a, f, v, x) {
      return a === null || a.tag !== 7
        ? ((a = Lt(f, d.mode, v, x)), (a.return = d), a)
        : ((a = l(a, f)), (a.return = d), a);
    }
    function m(d, a, f) {
      ...
      if (typeof a == "object" && a !== null) {
        switch (a.$$typeof) {
          case rr:
            return (
              (f = il(a.type, a.key, a.props, null, d.mode, f)),
              (f.ref = Fn(d, null, a)),
              (f.return = d),
              f
            );
          case Mt:
            return (a = Ci(a, d.mode, f)), (a.return = d), a;
          case Ge:
            var v = a._init;
    ...
    function p(d, a, f, v) {
      ...
      if ((typeof f == "string" && f !== "") || typeof f == "number")
        return x !== null ? null : u(d, a, "" + f, v);
      if (typeof f == "object" && f !== null) {
        switch (f.$$typeof) {
          case rr:
            return f.key === x ? s(d, a, f, v) : null;
          case Mt:
            return f.key === x ? c(d, a, f, v) : null;
          case Ge:
            return (x = f._init), p(d, a, x(f._payload), v);
        }
        if (dn(f) || cn(f)) return x !== null ? null : h(d, a, f, v, null);
        Dr(d, f);
      }
      return null;
    }
    function w(d, a, f, v, x) {
      if ((typeof v == "string" && v !== "") || typeof v == "number")
        return (d = d.get(f) || null), u(a, d, "" + v, x);
      if (typeof v == "object" && v !== null) {
        switch (v.$$typeof) {
          case rr:
            return (
              (d = d.get(v.key === null ? f : v.key) || null), s(a, d, v, x)
            );
          case Mt:
            return (
              (d = d.get(v.key === null ? f : v.key) || null), c(a, d, v, x)
            );
          case Ge:
            var _ = v._init;
            return w(d, a, f, _(v._payload), x);
        }
        if (dn(v) || cn(v)) return (d = d.get(f) || null), h(a, d, v, x, null);
        Dr(a, v);
      }
      return null;
    }
    function k(d, a, f, v) {
      for (
        var x = null, _ = null, N = a, P = (a = 0), V = null;
        N !== null && P < f.length;
        P++
      ) {
      ...
      if (P === f.length) return n(d, N), U && St(d, P), x;
      if (N === null) {
        for (; P < f.length; P++)
          (N = m(d, f[P], v)),
            N !== null &&
      ...
      for (N = r(d, N); P < f.length; P++)
        (V = w(N, d, P, f[P], v)),
          V !== null &&
            (e && V.alternate !== null && N.delete(V.key === null ? P : V.key),
            (a = o(V, a, P)),
            _ === null ? (x = V) : (_.sibling = V),
            (_ = V));
      return (
        e &&
    ...
    function S(d, a, f, v) {
      ...
      if (((f = x.call(f)), f == null)) throw Error(g(151));
      for (
        var _ = (x = null), N = a, P = (a = 0), V = null, L = f.next();
        N !== null && !L.done;
        P++, L = f.next()
      ) {
        N.index > P ? ((V = N), (N = null)) : (V = N.sibling);
        var Re = p(d, N, L.value, v);
        if (Re === null) {
          N === null && (N = V);
          break;
        }
        e && N && Re.alternate === null && t(d, N),
          (a = o(Re, a, P)),
          _ === null ? (x = Re) : (_.sibling = Re),
          (_ = Re),
          (N = V);
      }
      if (L.done) return n(d, N), U && St(d, P), x;
      if (N === null) {
        ...
        switch (f.$$typeof) {
          ...
          case Mt:
            e: {
              ...
              (a = Ci(f, d.mode, v)), (a.return = d), (d = a);
            }
            return i(d);
          case Ge:
            return (_ = f._init), O(d, a, _(f._payload), v);
        }
        if (dn(f)) return k(d, a, f, v);
      ...
      return (typeof f == "string" && f !== "") || typeof f == "number"
        ? ((f = "" + f),
          a !== null && a.tag === 6
            ...
            : (n(d, a), (a = Ei(f, d.mode, v)), (a.return = d), (d = a)),
          i(d))
        : n(d, a);
    }
    return O;
  ...
  function xe(e) {
    ...
    if (Ro !== e)
      if (((e = { context: e, memoizedValue: t, next: null }), bt === null)) {
        if (Ur === null) throw Error(g(308));
        (bt = e), (Ur.dependencies = { lanes: 0, firstContext: e });
      } else bt = bt.next = e;
    return t;
  }
  var xt = null;
  ...
  var Un = {},
    ...
    $n = ot(Un);
  function Et(e) {
    if (e === Un) throw Error(g(174));
    return e;
  }
  function Vo(e, t) {
    switch ((M($n, t), M(Vn, e), M(De, Un), (e = t.nodeType), e)) {
      case 9:
      case 11:
  ...
  var Ar = $e.ReactCurrentDispatcher,
    Bo = $e.ReactCurrentBatchConfig,
    Ct = 0,
    A = null,
    Y = null,
    Z = null,
  ...
  function Qo(e, t, n, r, l, o) {
    if (
      ...
      (t.updateQueue = null),
      (t.lanes = 0),
      (Ar.current = e === null || e.memoizedState === null ? td : nd),
      (e = n(r, l)),
      Hn)
    ) {
      o = 0;
      do {
        if (((Hn = !1), (An = 0), 25 <= o)) throw Error(g(301));
        (o += 1),
          (Z = Y = null),
          (t.updateQueue = null),
          (Ar.current = rd),
  ...
  function Yo(e) {
    ...
    if (((e = n.interleaved), e !== null)) {
      l = e;
      do (o = l.lane), (A.lanes |= o), (_t |= o), (l = l.next);
      while (l !== e);
  ...
  function Us(e, t) {
    ...
    if (
      ...
      (r = r.queue),
      Zo(Hs.bind(null, n, r, e), [e]),
      r.getSnapshot !== t || o || (Z !== null && Z.memoizedState.tag & 1))
    ) {
      if (
        ((n.flags |= 2048),
        Wn(9, $s.bind(null, n, r, l, t), void 0, null),
        G === null)
      )
        throw Error(g(349));
      Ct & 30 || Vs(n, t, l);
  ...
  function Qr(e, t, n, r) {
    ...
    (A.flags |= e), (l.memoizedState = Wn(1 | t, n, o, r));
  }
  function Ks(e, t) {
  ...
  function Gs(e, t, n) {
    return (
      (n = n != null ? n.concat([e]) : null), Qr(4, 4, Zs.bind(null, t, e), n)
    );
  }
  function Go() {}
  function Js(e, t) {
  ...
  function bs(e, t, n) {
    return Ct & 21
      ? (Pe(n, t) ||
          ((n = Lu()), (A.lanes |= n), (_t |= n), (e.baseState = !0)),
        t)
  ...
  var Kr = {
    ...
    td = {
      ...
      useImperativeHandle: function (e, t, n) {
        return (
          ...
          Wr(4194308, 4, Zs.bind(null, t, e), n)
        );
      },
      ...
      useSyncExternalStore: function (e, t, n) {
        ...
        return (
          ...
          (r.flags |= 2048),
          Wn(9, $s.bind(null, r, o, n, t), void 0, null),
          n
        );
      },
      useId: function () {
    ...
    rd = {
      ...
      useDeferredValue: function (e) {
        var t = Ee();
        return Y === null ? (t.memoizedState = e) : bs(t, Y.memoizedState, e);
      },
      useTransition: function () {
        var e = Xo(Bn)[0],
          t = Ee().memoizedState;
  ...
  function qo(e, t, n, r) {
    ...
    typeof o == "object" && o !== null
      ? (l.context = xe(o))
      : ((o = ce(t) ? wt : te.current), (l.context = Xt(e, o))),
      ...
      typeof t.getDerivedStateFromProps == "function" ||
        ...
        t !== l.state && Yr.enqueueReplaceState(l, l.state, null),
        $r(e, n, l, r),
        (l.state = e.memoizedState)),
...
` +
  ...
  var od = $e.ReactCurrentOwner,
    fe = !1;
  function ue(e, t, n, r) {
    t.child = e === null ? Ts(t, null, n, r) : qt(t, e.child, n, r);
  }
    ...
    return (
      ...
      e !== null && !fe
        ? ((t.updateQueue = e.updateQueue),
          ...
          (e.lanes &= ~l),
          Ye(e, t, l))
        : (U && n && zo(t), (t.flags |= 1), ue(e, t, r, l), t.child)
    );
  }
    ...
    return (
      ...
      e !== null && !fe
        ? ((t.updateQueue = e.updateQueue),
          ...
          (e.lanes &= ~l),
          Ye(e, t, l))
        : (U && r && zo(t), (t.flags |= 1), ue(e, t, n, l), t.child)
    );
  }
  function ga(e, t, n, r, l) {
    ...
    if ((en(t, l), t.stateNode === null))
      Zr(e, t), oa(t, n, r), qo(t, n, r, l), (r = !0);
    else if (e === null) {
      var i = t.stateNode,
        u = t.memoizedProps;
      i.props = u;
      ...
      u !== m || p !== k || ae.current || st
        ? (typeof w == "function" && (Jo(t, n, w, r), (k = t.memoizedState)),
          (c = st || la(t, n, c, r, p, k, s) || !1)
            ? (h ||
  ...
  function ni(e, t, n, r, l, o) {
    va(e, t);
    var i = (t.flags & 128) !== 0;
    if (!r && !i) return l && xs(t, n, !1), Ye(e, t, o);
  ...
  function wa(e, t, n, r, l) {
    return Jt(), Io(l), (t.flags |= 256), ue(e, t, n, r), t.child;
  }
  ...
  function id(e, t, n, r, l, o, i) {
    if (n)
      return t.flags & 256
        ? ((t.flags &= -257), (r = bo(Error(g(422)))), Xr(e, t, i, r))
        : t.memoizedState !== null
    ...
    if (l.data === "$!") {
      ...
      return (
        (r = u), (o = Error(g(419))), (r = bo(o, r, void 0)), Xr(e, t, i, r)
      );
    }
    if (((u = (i & e.childLanes) !== 0), fe || u)) {
      ...
      return Si(), (r = bo(Error(g(421)))), Xr(e, t, i, r);
    }
    return l.data === "$?"
      ? ((t.flags |= 128),
        (t.child = e.child),
  ...
  function ud(e, t, n) {
    switch (t.tag) {
      ...
      case 10:
        ...
        M(Fr, r._currentValue), (r._currentValue = l);
        break;
      case 13:
    ...
    switch ((Lo(t), t.tag)) {
          ...
          (e === null || e.child === null) &&
            (Or(t)
              ...
              : e === null ||
                ...
                ((t.flags |= 1024), ze !== null && (yi(ze), (ze = null)))),
          ui(e, t),
          re(t),
          null
        );
      case 5:
        ...
        if (((n = t.type), e !== null && t.stateNode != null))
          ...
          if (((e = Et(De.current)), Or(t))) {
            (r = t.stateNode), (n = t.type);
            var o = t.memoizedProps;
            switch (((r[Oe] = t), (r[On] = o), (e = (t.mode & 1) !== 0), n)) {
              case "dialog":
      ...
      case 6:
        if (e && t.stateNode != null) _a(e, t, e.memoizedProps, r);
          ...
          if (((n = Et($n.current)), Et(De.current), Or(t))) {
            if (
              ((r = t.stateNode),
              (n = t.memoizedProps),
              (r[Oe] = t),
          ...
          if (U && ye !== null && t.mode & 1 && !(t.flags & 128))
            ...
            if (e === null) {
              ...
              Jt(),
                ...
                (t.flags |= 4);
            re(t), (o = !1);
          } else ze !== null && (yi(ze), (ze = null)), (o = !0);
      ...
      case 17:
        return ce(t.type) && jr(), re(t), null;
      case 19:
        if ((F(H), (o = t.memoizedState), o === null)) return re(t), null;
  ...
  function ad(e, t) {
    switch ((Lo(t), t.tag)) {
      ...
      case 13:
        if (
          (F(H), (e = t.memoizedState), e !== null && e.dehydrated !== null)
        ) {
  ...
  function fd(e, t) {
    ...
    for (
      So = { focusedElem: e, selectionRange: n }, vr = !1, E = t;
      E !== null;
      ...
      case 5:
        ...
        if (r & 4 && ((l = e.stateNode), l != null)) {
          ...
          if (((e.updateQueue = null), s !== null))
            try {
              u === "input" && o.type === "radio" && o.name != null && iu(l, o),
                Hl(u, i);
              var c = Hl(u, o);
              ...
              switch (u) {
                ...
                case "select":
                  ...
                  w != null
                    ...
                    : p !== !!o.multiple &&
                      (o.defaultValue != null
                        ? Dt(l, !!o.multiple, o.defaultValue, !0)
                        : Dt(l, !!o.multiple, o.multiple ? [] : "", !1));
              }
              l[On] = o;
            } catch (S) {
              B(e, e.return, S);
  ...
  function Ra(e, t, n) {
    for (var r = (e.mode & 1) !== 0; E !== null; ) {
      ...
      if (l.tag === 22 && r) {
        ...
        l.subtreeFlags & 8772 && o !== null ? ((o.return = l), (E = o)) : Ma(e);
    }
  }
  function Ma(e) {
    for (; E !== null; ) {
  ...
  function Ie(e, t, n, r) {
    if (50 < Zn) throw ((Zn = 0), (vi = null), Error(g(185)));
    wn(e, n, r),
      (!(I & 2) || e !== G) &&
        (e === G && (!(I & 2) && (br |= n), X === 4 && mt(e, ee)),
        pe(e, r),
        n === 1 && I === 0 && !(t.mode & 1) && ((on = W() + 500), Ir && ut()));
  }
  function pe(e, t) {
    ...
    if (r === 0)
      ...
      if ((n != null && Nu(n), t === 1))
        e.tag === 0 ? Zf(Ua.bind(null, e)) : Es(Ua.bind(null, e)),
          Qf(function () {
            !(I & 6) && ut();
          }),
          (n = null);
  ...
  function Fa(e, t) {
    if (((rl = -1), (ll = 0), I & 6)) throw Error(g(327));
    var n = e.callbackNode;
    ...
    if (r & 30 || r & e.expiredLanes || t) t = ol(e, r);
      ...
      I |= 2;
      var o = $a();
      (G !== e || ee !== t) && ((Xe = null), (on = W() + 500), Pt(e, t));
      do
        try {
          vd();
          break;
      ...
      Mo(),
        (qr.current = o),
        (I = l),
        K !== null ? (t = 0) : ((G = null), (ee = 0), (t = X));
    }
    if (t !== 0) {
      if (
        (t === 2 && ((l = Zl(e)), l !== 0 && ((r = l), (t = gi(e, l)))),
        t === 1)
      )
        throw ((n = Yn), Pt(e, 0), mt(e, r), pe(e, W()), n);
      if (t === 6) mt(e, r);
      else {
        if (
        ...
        switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
          ...
          case 3:
            if (
              ...
              e.timeoutHandle = Eo(zt.bind(null, e, de, Xe), t);
              break;
            }
            zt(e, de, Xe);
            break;
          case 4:
            ...
            if (
              ...
              e.timeoutHandle = Eo(zt.bind(null, e, de, Xe), r);
              break;
            }
            zt(e, de, Xe);
            break;
    ...
    return pe(e, W()), e.callbackNode === n ? Fa.bind(null, e) : null;
  }
  function gi(e, t) {
    var n = Xn;
    return (
  ...
  function Ua(e) {
    ...
    if (n === 1) throw ((n = Yn), Pt(e, 0), mt(e, t), pe(e, W()), n);
  ...
  function Nt(e) {
    ...
    try {
      ...
      (R = r), (Ce.transition = n), (I = t), !(I & 6) && ut();
    }
  }
  function ki() {
    (we = ln.current), F(ln);
  ...
  function $a() {
    var e = qr.current;
    return (qr.current = Kr), e === null ? Kr : e;
  }
  function Si() {
    (X === 0 || X === 3 || X === 2) && (X = 4),
      G === null || (!(_t & 268435455) && !(br & 268435455)) || mt(G, ee);
  }
  function ol(e, t) {
    var n = I;
    I |= 2;
    var r = $a();
    (G !== e || ee !== t) && ((Xe = null), Pt(e, t));
    do
      try {
        hd();
        break;
    ...
    while (!0);
    if ((Mo(), (I = n), (qr.current = r), K !== null)) throw Error(g(261));
  ...
  function zt(e, t, n) {
    var r = R,
      l = Ce.transition;
    try {
      (Ce.transition = null), (R = 1), gd(e, t, n, r);
    } finally {
      (Ce.transition = l), (R = r);
    }
    return null;
  ...
  function un() {
    if (dt !== null) {
      var e = ju(nl),
        ...
        n = R;
      try {
        if (((Ce.transition = null), (R = 16 > e ? 16 : e), dt === null))
          var r = !1;
        else {
          if (((e = dt), (dt = null), (nl = 0), I & 6)) throw Error(g(331));
          var l = I;
          ...
          if (
            ((I = l), ut(), Me && typeof Me.onPostCommitFiberRoot == "function")
          )
            try {
              Me.onPostCommitFiberRoot(cr, e);
            } catch {}
          r = !0;
        }
        return r;
  ...
  function yd(e, t, n) {
    ...
    r !== null && r.delete(t),
      ...
      G === e &&
        (ee & n) === n &&
        (X === 4 || (X === 3 && (ee & 130023424) === ee && 500 > W() - mi)
          ? Pt(e, 0)
          : (pi |= n)),
      pe(e, t);
  }
  function Wa(e, t) {
    t === 0 &&
      (e.mode & 1
        ...
        : (t = 1));
    var n = se();
    (e = Qe(e, t)), e !== null && (wn(e, t, n), pe(e, n));
  }
  function wd(e) {
    var t = e.memoizedState,
      n = 0;
  ...
  Qa = function (e, t, n) {
    ...
    else (fe = !1), U && t.flags & 1048576 && Cs(t, Mr, t.index);
    switch (((t.lanes = 0), t.tag)) {
      case 2:
        var r = t.type;
        Zr(e, t), (e = t.pendingProps);
        var l = Xt(t, te.current);
        en(t, n), (l = Qo(null, t, r, e, l, n));
        var o = Ko();
        return (
          (t.flags |= 1),
          typeof l == "object" &&
          ...
          l.$$typeof === void 0
            ? ((t.tag = 1),
              ...
              qo(t, r, e, n),
              (t = ni(null, t, r, !0, o, n)))
            : ((t.tag = 0), U && o && zo(t), ue(null, t, l, n), (t = t.child)),
          t
        );
      case 16:
        r = t.elementType;
      ...
      case 3:
        e: {
          if ((ya(t), e === null)) throw Error(g(387));
          (r = t.pendingProps),
            (o = t.memoizedState),
            (l = o.element),
            Rs(e, t),
          ...
          if (((r = i.element), o.isDehydrated))
            if (
              ...
              (l = nn(Error(g(423)), t)), (t = wa(e, t, r, n, l));
              break e;
            } else if (r !== l) {
              (l = nn(Error(g(424)), t)), (t = wa(e, t, r, n, l));
              break e;
            } else
              for (
      ...
      case 4:
        return (
          Vo(t, t.stateNode.containerInfo),
          (r = t.pendingProps),
          e === null ? (t.child = qt(t, null, r, n)) : ue(e, t, r, n),
          t.child
        );
      case 11:
        return (
  ...
  function il(e, t, n, r, l, o) {
    ...
    if (((r = e), typeof e == "function")) xi(e) && (i = 1);
      ...
      e: switch (e) {
        ...
        case Nl:
          return (
            (e = _e(12, n, t, l | 2)), (e.elementType = Nl), (e.lanes = o), e
          );
        case zl:
          return (e = _e(13, n, t, l)), (e.elementType = zl), (e.lanes = o), e;
        case Ll:
          return (e = _e(19, n, t, l)), (e.elementType = Ll), (e.lanes = o), e;
        case tu:
          return ul(n, l, o, t);
        default:
  ...
  function Ya(e) {
    ...
    e = e._reactInternals;
    e: {
      if (gt(e) !== e || e.tag !== 1) throw Error(g(170));
      var t = e;
      do {
        switch (t.tag) {
          case 3:
  ...
  (cl.prototype.render = Pi.prototype.render =
    function (e) {
      var t = this._internalRoot;
      if (t === null) throw Error(g(409));
      sl(e, t, null, null);
    }),
    (cl.prototype.unmount = Pi.prototype.unmount =
      function () {
  ...
  (Tu = function (e) {
    switch (e.tag) {
      case 3:
        ...
        if (t.current.memoizedState.isDehydrated) {
          ...
          n !== 0 &&
            (Jl(t, n | 1), pe(t, W()), !(I & 6) && ((on = W() + 500), ut()));
        }
        break;
      case 13:
        Nt(function () {
    ...
    (yu = wi),
    (wu = Nt);
  var Pd = { usingClientEntryPoint: !1, Events: [Dn, Kt, Lr, vu, gu, wi] },
    Gn = {
    ...
    zd = {
      ...
      findFiberByHostInstance: Gn.findFiberByHostInstance || _d,
  ...
  if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
    ...
    if (!pl.isDisabled && pl.supportsFiber)
      try {
        (cr = pl.inject(zd)), (Me = pl);
      } catch {}
  }
  (me.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Pd),
    (me.createPortal = function (e, t) {
      var n =
        2 < arguments.length && arguments[2] !== void 0 ? arguments[2] : null;
      if (!zi(t)) throw Error(g(200));
      return Cd(e, t, null, n);
    }),
    (me.createRoot = function (e, t) {
      if (!zi(e)) throw Error(g(299));
      var n = !1,
        r = "",
        l = Ga;
      return (
    ...
    (me.hydrateRoot = function (e, t, n) {
      ...
      if (
        ...
        (t = Xa(t, null, e, 1, n ?? null, l, !1, o, i)),
        (e[He] = t.current),
        Rn(e),
        r)
      )
  ...
  var Ld = Yi.exports,
    Li,
    ba = Ld;
  (Li = ba.createRoot), ba.hydrateRoot;
  const ec = ({ config: e }) => {
    const [t, n] = Ze.useState(!1),
      [r, l] = Ze.useState({
        userImage: "",
        clothingImage: "",
        clothingImageUrl: "",
    ...
    Ze.useEffect(() => {
      setTimeout(() => {
        const f = [
          ...
          v = document.querySelector(f.join(", "));
        v && v.src && l((x) => ({ ...x, clothingImageUrl: v.src }));
      }, 1e3);
    }, []);
    const w = (a, f) => {
        var _;
        ...
        if (!v) return;
        if ((h(""), v.size > 5 * 1024 * 1024)) {
          h("File too large. Please upload an image under 5MB.");
          return;
        }
        const x = new FileReader();
        (x.onload = (N) => {
          var V;
          const P = (V = N.target) == null ? void 0 : V.result;
          l(
            f === "user"
              ? (L) => ({ ...L, userImage: P })
              : (L) => ({ ...L, clothingImage: P, clothingImageUrl: "" })
          );
        }),
          x.readAsDataURL(v);
      },
      k = async () => {
        if (!r.userImage || (!r.clothingImage && !r.clothingImageUrl)) {
          h("Please upload both your photo and select a clothing item.");
          return;
        }
        h(""), l((a) => ({ ...a, isProcessing: !0 }));
        try {
          const a = await fetch(`${e.apiUrl}/api/try-on`, {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
                appId: e.appId,
                userImage: r.userImage,
                clothingImage: r.clothingImage || void 0,
                clothingImageUrl: r.clothingImageUrl || void 0,
              }),
            }),
            f = await a.json();
          if (a.ok)
            s(f.resultImage),
              i(!0),
              S("try_on_success", { sessionId: f.sessionId });
          else throw new Error(f.error || "Try-on failed");
        } catch (a) {
          console.error("Try-on error:", a),
            h(a.message || "Try-on failed. Please try again."),
            S("try_on_failed", { error: a.message });
        } finally {
          l((a) => ({ ...a, isProcessing: !1 }));
        }
      },
      S = (a, f = {}) => {
        fetch(`${e.apiUrl}/api/analytics`, {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ appId: e.appId, eventType: a, metadata: f }),
        }).catch(console.error);
      },
      O = () => {
        l((a) => ({ ...a, userImage: "" }));
      ...
      d = () => {
        l((a) => ({ ...a, clothingImage: "", clothingImageUrl: "" }));
      };
    return t
      ? y.jsxs(y.Fragment, {
          children: [
            y.jsx("div", {
              className: `fixed ${m[e.position]} z-[10000] w-80`,
              children: y.jsxs("div", {
                className: `${
                  p[e.theme]
                      ...
                      children: [
                        y.jsxs("div", {
                          ...
                          children: [
                            y.jsx("div", {
                              className:
                                "w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center",
                              children: y.jsx("svg", {
                                className: "w-4 h-4",
                                viewBox: "0 0 24 24",
                                fill: "currentColor",
                                children: y.jsx("path", {
                                  d: "M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2ZM21 9V7L15 1H5C3.89 1 3 1.89 3 3V21A2 2 0 0 0 5 23H19A2 2 0 0 0 21 21V9M19 9H14V4H5V19H19V9Z",
                                }),
                              }),
                            }),
                            y.jsx("h3", {
                        ...
                        y.jsx("button", {
                          onClick: () => n(!1),
                          className:
                            "text-white hover:bg-white/20 p-1 rounded transition-colors",
                          children: y.jsx("svg", {
                            className: "w-4 h-4",
                            viewBox: "0 0 24 24",
                            fill: "currentColor",
                    ...
                    children: [
                      ...
                      y.jsxs("div", {
                        children: [
                          ...
                          y.jsxs("div", {
                            className:
                              "border-2 border-dashed border-blue-300 rounded-lg p-4 text-center bg-blue-50 hover:bg-blue-100 transition-colors cursor-pointer",
                            children: [
                              y.jsx("input", {
                                type: "file",
                                accept: "image/*",
                                ...
                                children: r.userImage
                                  ? y.jsxs("div", {
                                      ...
                                      children: [
                                        y.jsx("img", {
                                          ...
                                          alt: "Your photo",
                                          className:
                                            "w-16 h-16 object-cover rounded-lg mx-auto",
                                        }),
                                        y.jsx("p", {
                                          className:
                                  ...
                                  : y.jsxs("div", {
                                      ...
                                      children: [
                                        y.jsx("svg", {
                                          className:
                                            "w-8 h-8 text-blue-600 mx-auto",
                                          viewBox: "0 0 24 24",
                                          fill: "currentColor",
                                          children: y.jsx("path", {
                                            d: "M9 2L7.17 4H4C2.9 4 2 4.9 2 6V18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6C22 4.9 21.1 4 20 4H16.83L15 2H9ZM12 7C15.31 7 18 9.69 18 13C18 16.31 15.31 19 12 19C8.69 19 6 16.31 6 13C6 9.69 8.69 7 12 7Z",
                                          }),
                                        }),
                                        y.jsx("p", {
                                          className:
                      ...
                      y.jsxs("div", {
                        children: [
                          ...
                          y.jsxs("div", {
                            className:
                              "border-2 border-dashed border-gray-300 rounded-lg p-4 text-center bg-gray-50",
                            children: [
                              y.jsx("input", {
                                type: "file",
                                accept: "image/*",
                                onChange: (a) => w(a, "clothing"),
                                className: "hidden",
                                id: "clothing-upload",
                              }),
                              y.jsx("label", {
                                ...
                                className: "cursor-pointer",
                                children:
                                  r.clothingImage || r.clothingImageUrl
                                    ? y.jsxs("div", {
                                        className: "space-y-2",
                                        children: [
                                          y.jsx("img", {
                      ...
                      y.jsx("button", {
                        ...
                        disabled:
                          ...
                          (!r.clothingImage && !r.clothingImageUrl),
                        className:
                          "w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white py-3 px-4 rounded-lg font-semibold transition-colors",
                        children: r.isProcessing
                          ? y.jsxs("div", {
                              className:
                              ...
                              children: [
                                ...
                                y.jsx("span", { children: "Processing..." }),
                              ],
                            })
                          : y.jsxs("div", {
                              className:
                              ...
                              children: [
                                y.jsx("svg", {
                                  ...
                                  fill: "currentColor",
                                  children: y.jsx("path", {
                                    d: "M7,2V4H8V18A4,4 0 0,0 12,22A4,4 0 0,0 16,18V4H17V2H7M11,16C10.4,16 10,15.6 10,15C10,14.4 10.4,14 11,14C11.6,14 12,14.4 12,15C12,15.6 11.6,16 11,16M13,12C12.4,12 12,11.6 12,11C12,10.4 12.4,10 13,10C13.6,10 14,10.4 14,11C14,11.6 13.6,12 13,12Z",
                                  }),
                                }),
                                y.jsx("span", { children: "Try On Now" }),
                              ],
                            }),
                      }),
                      y.jsx("div", {
                        className: "bg-blue-50 rounded-lg p-3 text-xs",
                        children: y.jsxs("div", {
                          className: "flex items-start space-x-2",
                          children: [
                            y.jsx("div", {
                              className:
                                "w-4 h-4 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5",
                              children: y.jsx("span", {
                            ...
                            y.jsxs("div", {
                              ...
                              children: [
                                ...
                                y.jsxs("ul", {
                                  ...
                                  children: [
                                    y.jsx("li", {
                                      children: "• Use a full-body photo",
                                    }),
                                    y.jsx("li", {
                                      children: "• Stand facing forward",
                                    }),
                                    y.jsx("li", {
                                      children: "• Plain background works best",
                                    }),
                                  ],
                                }),
                              ],
            ...
            o &&
              y.jsx("div", {
                className:
                  "fixed inset-0 bg-black bg-opacity-50 z-[10001] flex items-center justify-center p-4",
                children: y.jsxs("div", {
                  className:
                    "bg-white rounded-lg max-w-4xl max-h-[90vh] overflow-y-auto",
                  children: [
                    y.jsxs("div", {
                      className:
                    ...
                    y.jsxs("div", {
                      ...
                      children: [
                            ...
                            y.jsxs("div", {
                              children: [
                                ...
                                y.jsx("img", {
                                  ...
                                  alt: "Original photo",
                                  className:
                                    "w-full h-80 object-cover rounded-lg shadow-md",
                                }),
                              ],
                            }),
                            y.jsxs("div", {
                        ...
                        y.jsx("button", {
                          onClick: () => i(!1),
                          className:
                            "w-full bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-lg font-semibold",
                          children: "Close",
                        }),
                      ],
                    }),
      ...
      : y.jsx("div", {
          className: `fixed ${m[e.position]} z-[10000]`,
          children: y.jsx("button", {
            onClick: () => {
              n(!0), S("view");
            },
            className:
              "w-16 h-16 rounded-full bg-blue-600 hover:bg-blue-700 shadow-2xl flex items-center justify-center transition-all hover:scale-110",
  ...
  function tc() {
    const e = document.querySelectorAll("script[data-app-id]"),
      t = e[e.length - 1],
      n = {
        appId: (t == null ? void 0 : t.dataset.appId) || "demo",
        position: (t == null ? void 0 : t.dataset.position) || "bottom-right",
        theme: (t == null ? void 0 : t.dataset.theme) || "default",
        apiUrl:
          (t == null ? void 0 : t.dataset.apiUrl) || window.location.origin,
      },
      r = document.createElement("div");
    (r.id = "tryon-ai-widget"),
      document.body.appendChild(r),
      Li(r).render(y.jsx(ec, { config: n }));
  }
    ...
    (window.TryOnAI = {
      init: (e) => {
        const t = {
            ...
            apiUrl: e.apiUrl || window.location.origin,
          },
          n = document.createElement("div");
        (n.id = "tryon-ai-widget"),
          document.body.appendChild(n),
          Li(n).render(y.jsx(ec, { config: t }));
      },
    });
})();
